...
\begin{frame}[fragile]{Lösungsqualität für Pref. Attach. in Abhängigkeit von $n$}
    \begin{center}
...
\begin{frame}[fragile]{Lösungsqualität für Binärbäume in Abhängigkeit von $n$}
    \begin{center}
        \begin{tikzpicture}[font=\footnotesize]
            \renewcommand{\datadir}{data/trees/quality/node_count}
            \renewcommand{\plotdata}[2]{%
...
\begin{frame}[fragile]{Lösungsqualität für Pref. Attach. in Abhängigkeit von $\eps$}
    \begin{center}
        \begin{tikzpicture}[font=\footnotesize]
...
\begin{frame}[fragile]{Lösungsqualität für Binärbäume in Abhängigkeit von $\eps$}
    \begin{center}
        \begin{tikzpicture}[font=\footnotesize]
            \renewcommand{\datadir}{data/trees/quality/imbalance}
            \renewcommand{\plotdata}[2]{%
