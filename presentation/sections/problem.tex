\begin{frame}[fragile]{$k$\hyp balancierte Partitionierung}
    \begin{columns}[onlytextwidth]
        \begin{column}{0.5\textwidth}
            Partitioniere Knoten in Mengen $V_1, \ldots, V_k$ mit
            \begin{itemize}[<+(1)->]
        ...
        \begin{column}{0.5\textwidth}
            \begin{tikzpicture}[scale=0.6, every node/.style={scale=0.6, circle}]
                ...
                \draw (-4.0,4.3) node[fill=TUMSecondaryBlue] (A) {$A$};
                \draw (-2.6,3.9) node[fill=TUMSecondaryBlue] (B) {$B$};
                \draw (-1.8,3.1) node[fill=TUMSecondaryBlue] (C) {$C$};
                \draw (-1.2,4.1) node[fill=TUMSecondaryBlue] (D) {$D$};
                \draw (-5.4,1.9) node[fill=TUMAccentOrange] (E) {$E$};
                \draw (-6.2,2.8) node[fill=TUMAccentOrange] (F) {$F$};
                \draw (-6.2,1.0) node[fill=TUMAccentOrange] (G) {$G$};
                \draw (-4.8,0.6) node[fill=TUMAccentOrange] (H) {$H$};
                \draw (-0.5,0.7) node[fill=TUMAccentGreen] (I) {$I$};
                \draw (-2.1,-0.4) node[fill=TUMAccentGreen] (J) {$J$};
                \draw (-0.4,-0.3) node[fill=TUMAccentGreen] (K) {$K$};
                \draw (-2.2,1.1) node[fill=TUMAccentGreen] (L) {$L$};
        ...
        \begin{column}{0.5\textwidth}
            ...
            \only<3->{
                \begin{tikzpicture}[scale=0.6, every node/.style={scale=0.6, circle}]
                    ...
                    \draw [rotate around={38.40:(-1.5,-0.1)},line width=1.pt, dashed, TUMAccentGreen] (-1.4,0.0) ellipse (1.7cm and 1.9cm);
                    \draw (-4.0,4.3) node[fill=TUMAccentOrange] (A) {$A$};
                    \draw (-2.6,3.9) node[fill=TUMSecondaryBlue] (B) {$B$};
                    \draw (-1.8,3.1) node[fill=TUMSecondaryBlue] (C) {$C$};
                    \draw (-1.2,4.1) node[fill=TUMSecondaryBlue] (D) {$D$};
                    \draw (-5.4,1.9) node[fill=TUMAccentOrange] (E) {$E$};
