...
for ((i=70; i<=100; i+=10)); do
    ...
    ../../../../build/bachelorthesis-1.0.0/cli -g graph_pref_attach -n $i -e 25 -t 10 -o graph | java -jar ../../../../deps/hierarchical-decomposition/build/libs/hierarchical-decomposition.jar 10 > "pref_attach25n$i.graph" &
    wait
done
