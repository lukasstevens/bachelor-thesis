...
\begin{tikzpicture}
    ...
    \begin{groupplot}[
        ...
        \addplot+ [boxplot] table[y=2] {\datadir/pref_attach/n60k2i1div4.dat};%
        \addlegendentry{{$n=60$, $k=2$, $\varepsilon=1/4$}}
        \addplot+ [boxplot] table[y=2] {\datadir/pref_attach/n60k3i1div3.dat};%
        \addlegendentry{{$n=60$, $k=3$, $\varepsilon=1/3$}}
        \addplot+ [boxplot] table[y=2] {\datadir/pref_attach/n100k2i1div3.dat};%
        \addlegendentry{{$n=100$, $k=2$, $\varepsilon=1/3$}}
        \pgfplotsinvokeforeach {3,4,5,7,9} {
        ...
        \nextgroupplot[
            ...
            ytick distance=200, xticklabels={2,3,4,5,7,9},
            ylabel=Laufzeit (ms),
