...
\begin{tikzpicture}
    ...
    \newcommand{\plotdata}[2]{%
        \addplot+ [boxplot] table[y=#1] {\datadir/METIS_Kway_#2_n80k2.dat};%
        \addplot+ [boxplot] table[y=#1] {\datadir/METIS_Kway_#2_n80k3.dat};%
        \addplot+ [boxplot] table[y=#1] {\datadir/METIS_Kway_#2_n80k4.dat};%
        }
    ...
    \begin{groupplot}[
        ...
        \addplot+ [boxplot] table[y=8/20] {\datadir/METIS_Kway_rand_attach_n80k2.dat};%
        \addlegendentry{{$n=80$, $k=2$}}
        \addplot+ [boxplot] table[y=8/20] {\datadir/METIS_Kway_rand_attach_n80k3.dat};%
        \addlegendentry{{$n=80$, $k=3$}}
        \addplot+ [boxplot] table[y=8/20] {\datadir/METIS_Kway_rand_attach_n80k4.dat};%
