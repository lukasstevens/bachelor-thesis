...
\begin{tikzpicture}
    ...
    \newcommand{\plotdata}[2]{%
        \addplot+ [boxplot] table[y=#1] {\datadir/METIS_Kway_#2_k2i1div3.dat};%
        \addplot+ [boxplot] table[y=#1] {\datadir/METIS_Kway_#2_k4i1div3.dat};%
        \addplot+ [boxplot] table[y=#1] {\datadir/METIS_Kway_#2_k6i1div3.dat};%
        }
    ...
    \begin{groupplot}[
        ...
        \addplot+ [boxplot] table[y=70] {\datadir/METIS_Kway_rand_attach_k2i1div3.dat};%
        \addlegendentry{{$k=2$, $\eps=1/3$}}
        \addplot+ [boxplot] table[y=70] {\datadir/METIS_Kway_rand_attach_k4i1div3.dat};%
        \addlegendentry{{$k=4$, $\eps=1/3$}}
        \addplot+ [boxplot] table[y=70] {\datadir/METIS_Kway_rand_attach_k6i1div3.dat};%
