...
\begin{tikzpicture}
    ...
    \newcommand{\plotdata}[3]{%
        \addplot+ [boxplot] table[y=#1] {\datadir/#2_#3_rst_k2i1div3.dat};%
        \addplot+ [boxplot] table[y=#1] {\datadir/#2_#3_rst_k4i1div3.dat};%
        \addplot+ [boxplot] table[y=#1] {\datadir/#2_#3_rst_k6i1div3.dat};%
        }
    ...
    \begin{groupplot}[
        ...
        \addplot+ [boxplot] table[y=70] {\datadir/METIS_Recursive_edge_prob1_rst_k2i1div3.dat};%
        \addlegendentry{{$k=2$, $\eps=1/3$}}
        \addplot+ [boxplot] table[y=70] {\datadir/METIS_Recursive_edge_prob1_rst_k4i1div3.dat};%
        \addlegendentry{{$k=4$, $\eps=1/3$}}
        \addplot+ [boxplot] table[y=70] {\datadir/METIS_Recursive_edge_prob1_rst_k6i1div3.dat};%
