...
\begin{tikzpicture}
    ...
    \begin{groupplot}[
        ...
        \addplot+ [boxplot] table[y=70] {\datadir/METIS_Recursive_pref_attach5_rst_k2i1div3.dat};%
        \addlegendentry{{$k=2$, $\eps=1/3$}}
        \addplot+ [boxplot] table[y=70] {\datadir/METIS_Recursive_pref_attach5_rst_k4i1div3.dat};%
        \addlegendentry{{$k=4$, $\eps=1/3$}}
        \addplot+ [boxplot] table[y=70] {\datadir/METIS_Recursive_pref_attach5_rst_k6i1div3.dat};%
