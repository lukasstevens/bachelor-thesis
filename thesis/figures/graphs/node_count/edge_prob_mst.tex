...
\begin{tikzpicture}
    ...
    \begin{groupplot}[
        ...
        \addplot+ [boxplot] table[y=70] {\datadir/METIS_Recursive_edge_prob1_mst_k2i1div3.dat};%
        \addlegendentry{{$k=2$, $\eps=1/3$}}
        \addplot+ [boxplot] table[y=70] {\datadir/METIS_Recursive_edge_prob1_mst_k4i1div3.dat};%
        \addlegendentry{{$k=4$, $\eps=1/3$}}
        \addplot+ [boxplot] table[y=70] {\datadir/METIS_Recursive_edge_prob1_mst_k6i1div3.dat};%
