...
\begin{document}
\begin{tikzpicture}
    \newcommand{\datadir}{data/graphs/node_count/edge_prob}
    ...
    \begin{groupplot}[
        ...
        \addplot+ [boxplot] table[y=70] {\datadir/METIS_Recursive_edge_prob1_decomp_k2i1div3.dat};%
        \addlegendentry{{$k=2$, $\eps=1/3$}}
        \addplot+ [boxplot] table[y=70] {\datadir/METIS_Recursive_edge_prob1_decomp_k4i1div3.dat};%
        \addlegendentry{{$k=4$, $\eps=1/3$}}
        \addplot+ [boxplot] table[y=70] {\datadir/METIS_Recursive_edge_prob1_decomp_k6i1div3.dat};%
