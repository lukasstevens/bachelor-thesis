...
\begin{tikzpicture}
    ...
    \newcommand{\plotdata}[3]{%
        \addplot+ [boxplot] table[y=#1] {\datadir/#2_#3_mst_n80k2.dat};%
        \addplot+ [boxplot] table[y=#1] {\datadir/#2_#3_mst_n80k3.dat};%
        \addplot+ [boxplot] table[y=#1] {\datadir/#2_#3_mst_n80k4.dat};%
        }
    ...
    \begin{groupplot}[
        ...
        \addplot+ [boxplot] table[y=8/20] {\datadir/METIS_Recursive_pref_attach5_mst_n80k2.dat};%
        \addlegendentry{{$n=80$, $k=2$}}
        \addplot+ [boxplot] table[y=8/20] {\datadir/METIS_Recursive_pref_attach5_mst_n80k3.dat};%
        \addlegendentry{{$n=80$, $k=3$}}
        \addplot+ [boxplot] table[y=8/20] {\datadir/METIS_Recursive_pref_attach5_mst_n80k4.dat};%
