...
\todo{Kann man hier wirklich exponentielle Steigerung sehen?} Die Werte für Random Attachment, Preferrential Attachment und Binärbäume in Abbildung~\ref{fig:runimb} weisen für die Parameterwahl $n = 100$ und $k = 2$ zumindest eine exponentielle Entwicklung auf.
