...
Nun wird die Auswirkung des maximalen Ungleichgewichts der Partitionierung $\eps$ auf die Laufzeit untersucht, das auschließlich einen negativen Einfluss auf die Laufzeit hat.
