...
\begin{figure}[t]
    \centering
    \scalebox{1.0}{\includestandalone{figures/trees/runtime/node_count}}
...
\begin{figure}[t]
    \centering
    \scalebox{1.0}{\includestandalone{figures/trees/runtime/imbalance}}
...
\begin{figure}
    \centering
    \scalebox{1.0}{\includestandalone{figures/trees/runtime/kparts}}
...
\begin{figure}
    \centering
    \scalebox{1.0}{\includestandalone{figures/trees/runtime/max_degree}}
...
\begin{figure}
    \centering
    \scalebox{0.8}{\includestandalone{figures/trees/quality/tree_heuristics/rand_attach}}
    \scalebox{0.8}{\includestandalone{figures/trees/quality/tree_heuristics/pref_attach}}
    \scalebox{0.8}{\includestandalone{figures/trees/quality/tree_heuristics/fat}}
    \scalebox{0.8}{\includestandalone{figures/trees/quality/tree_heuristics/bnary}}
\end{figure}
\subsection{Graphen}
