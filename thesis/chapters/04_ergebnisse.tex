...
Wenn der Algorithmus dieser Arbeit auf einem Graphen eine Partitionierung mit Kosten $c_A$ berechnet und eine Heuristik eine Partitionierung mit Kosten $c_H$, dann berechnet sich die relative Lösungsqualität durch 
\begin{equation*}
    \frac{c_A}{c_H}. 
\end{equation*}
