...
\section{Berechnungskomplexität von perfekt ausgewogenen Partitionierungen \todo{Titel!}}\label{sec:complex}
...
\begin{proof}
    ...
    In \parencite{gj79} wurde die starke $NP$\hyp Vollständigkeit dieses Problems gezeigt, das heißt, es ist auch schon $NP$\hyp vollständig, wenn sowohl alle $a_i$, als auch $A$, polynomiell beschränkt sind.
...
Dort wurde gezeigt, dass das $(k,1)$\hyp Partitionierungsproblem auch dann $NP$\hyp vollständig bleibt, wenn man sich auf Bäume als Eingabegraphen beschränkt.
