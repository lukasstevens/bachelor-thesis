...
Die vorangegangenen Erkenntisse zeigen, dass auch für bestimmte eingeschränkte Graphen kein Approximationsalgorithmus für das $(k,1)$\hyp Partitionierungsproblem gefunden werden kann, außer es gilt $P=NP$. 
...
Wie im vorherigem Abschnitt gezeigt, ist das $(k,1)$\hyp Partitionierungsproblems schwer zu approximieren. 
...
Damit ist dieser Algorithmus ein \todo{PTAS einführen} PTAS für das $(k,1)$\hyp Partitionierungsproblem auf Bäumen. 
