...
\begin{defn}[Level]\label{def:level}
    ...
    Ein Level $L_T(l)$ ist die Menge aller Knoten, die eine Distanz von $l$ zu $r$ haben.
...
\todo[inline]{Selbe Implementierung wie Boost, evtl. Experimente zu Kollisionen?}
...
\subsection{Packing}
Behätersignaturen sind Signaturen, Packingzustand ist Signatur, Packing ist vector von vector von int.
Alles nicht besonders interessant
\todo[inline]{Soll dieses Kapitel weggelassen werden? Auf die Algorithmen wird auch nicht genau eingegangen.}
